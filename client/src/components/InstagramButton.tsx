      ...
      <div className="flex items-center gap-2">
        ...
        >
          <Button
            asChild
            size="icon"
            className="w-14 h-14 sm:w-16 sm:h-16 md:w-14 md:h-14 rounded-full shadow-2xl relative overflow-hidden border-none cursor-pointer touch-manipulation"
          ...
          >
            ...
            >
              ...
              >
                <SiInstagram 
                  className="w-7 h-7 sm:w-8 sm:h-8 md:w-7 md:h-7 text-white" 
